...
export default {
  terrain: {
    'P': {color:0x1a1820,height:5.0,block:true},   // sheer cliff face
    'R': {color:0x28263a,height:4.0,block:true},   // rocky peak
    'r': {color:0x48455a,height:2.2,def:1.4,mov:2},// rocky ridge approach
    'i': {color:0x78a0c0,height:1.6,def:0.7,mov:3},// ice/snow slope
    'b': {color:0x4a3c38,height:2.5,def:2.8,mov:1},// enemy bunker position
    'f': {color:0x5a5060,height:1.8,def:1.6,mov:2},// frozen rocky ledge
    '.': {color:0x706870,height:1.2,def:1.0,mov:1},// bare rocky ground
  },
  map: [
  ...
  indStarts: [
    ...
    {col:6,row:8,type:'section_cdr',name:'Lt Saurabh Kalia',    platoon:9,bio:'13 JAK RIF patrol. Captured and killed by Pakistani forces before the main battle. His sacrifice galvanised the regiment.'},
    {col:3,row:7,type:'section_cdr',name:'Hav Sanjay Kumar',    platoon:8,bio:'13 JAK RIF. Cleared the first bunker single-handed. Param Vir Chakra — the only living PVC recipient of Kargil.'},
  ...
  histCards: {
    1: {
      ...
      body:  'Capt Vikram Batra captured Point 5140 on 20 June 1999. His call sign was "Sher Shah" — the Lion King. His code message on capturing the peak, "Yeh Dil Maange More" (This heart wants more), became the defining phrase of Operation Vijay. He was 24 years old. He was killed hours later going back for a wounded comrade.',
    },
    3: {
      name:  'Havildar Sanjay Kumar — Living PVC',
      rank:  '13 JAK RIF · Param Vir Chakra',
      body:  'Hav Sanjay Kumar cleared the first bunker on the Flat Top feature single-handed, absorbing multiple bullet wounds and continuing to fight. He is one of only two living Param Vir Chakra recipients. He received the honour from President K.R. Narayanan in 2000.',
    },
  },
  ...
  debriefHistory:'Point 5140 was captured by 13 JAK RIF on 20 June 1999. Capt Vikram Batra\'s code words "Yeh Dil Maange More" on capturing the peak became the motto of Operation Vijay. He was awarded the Param Vir Chakra posthumously. Hav Sanjay Kumar received a living Param Vir Chakra for the same action.',
};
